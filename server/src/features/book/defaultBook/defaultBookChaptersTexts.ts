const chapter_1_name = 'Chapter I'
const chapter_1_header = 'The Cyclone'
const chapter_1_text = `Dorothy lived in the midst of the great Kansas prairies, with Uncle Henry, who was a farmer, and Aunt Em, who was the farmer’s wife. Their house was small, for the lumber to build it had to be carried by wagon many miles. There were four walls, a floor and a roof, which made one room; and this room contained a rusty looking cookstove, a cupboard for the dishes, a table, three or four chairs, and the beds. Uncle Henry and Aunt Em had a big bed in one corner, and Dorothy a little bed in another corner. There was no garret at all, and no cellar—except a small hole dug in the ground, called a cyclone cellar, where the family could go in case one of those great whirlwinds arose, mighty enough to crush any building in its path. It was reached by a trap door in the middle of the floor, from which a ladder led down into the small, dark hole.
...
const chapter_2_name = 'Chapter II'
const chapter_2_header = 'The Council with the Munchkins'
const chapter_2_text = `She was awakened by a shock, so sudden and severe that if Dorothy had not been lying on the soft bed she might have been hurt. As it was, the jar made her catch her breath and wonder what had happened; and Toto put his cold little nose into her face and whined dismally. Dorothy sat up and noticed that the house was not moving; nor was it dark, for the bright sunshine came in at the window, flooding the little room. She sprang from her bed and with Toto at her heels ran and opened the door.
...
const chapter_3_name = 'Chapter III'
const chapter_3_header = 'How Dorothy Saved the Scarecrow'
const chapter_3_text = `When Dorothy was left alone she began to feel hungry. So she went to the cupboard and cut herself some bread, which she spread with butter. She gave some to Toto, and taking a pail from the shelf she carried it down to the little brook and filled it with clear, sparkling water. Toto ran over to the trees and began to bark at the birds sitting there. Dorothy went to get him, and saw such delicious fruit hanging from the branches that she gathered some of it, finding it just what she wanted to help out her breakfast.
...
const chapter_5_name = 'Chapter V'
const chapter_5_header = 'The Rescue of the Tin Woodman'
const chapter_5_text = `When Dorothy awoke the sun was shining through the trees and Toto had long been out chasing birds around him and squirrels. She sat up and looked around her. There was the Scarecrow, still standing patiently in his corner, waiting for her.
...
const chapter_6_name = 'Chapter VI'
const chapter_6_header = 'The Cowardly Lion'
const chapter_6_text = `All this time Dorothy and her companions had been walking through the thick woods. The road was still paved with yellow brick, but these were much covered by dried branches and dead leaves from the trees, and the walking was not at all good.
...
const chapter_8_name = 'Chapter VIII'
const chapter_8_header = 'The Deadly Poppy Field'
const chapter_8_text = `Our little party of travelers awakened the next morning refreshed and full of hope, and Dorothy breakfasted like a princess off peaches and plums from the trees beside the river. Behind them was the dark forest they had passed safely through, although they had suffered many discouragements; but before them was a lovely, sunny country that seemed to beckon them on to the Emerald City.
...
const chapter_9_name = 'Chapter IX'
const chapter_9_header = 'The Queen of the Field Mice'
const chapter_9_text = `“We cannot be far from the road of yellow brick, now,” remarked the Scarecrow, as he stood beside the girl, “for we have come nearly as far as the river carried us away.”
...
const chapter_10_name = 'Chapter X'
const chapter_10_header = 'The Guardian of the Gates'
const chapter_10_text = `It was some time before the Cowardly Lion awakened, for he had lain among the poppies a long while, breathing in their deadly fragrance; but when he did open his eyes and roll off the truck he was very glad to find himself still alive.
...
const chapter_11_name = 'Chapter XI'
const chapter_11_header = 'The Emerald City of Oz'
const chapter_11_text = `Even with eyes protected by the green spectacles, Dorothy and her friends were at first dazzled by the brilliancy of the wonderful City. The streets were lined with beautiful houses all built of green marble and studded everywhere with sparkling emeralds. They walked over a pavement of the same green marble, and where the blocks were joined together were rows of emeralds, set closely, and glittering in the brightness of the sun. The window panes were of green glass; even the sky above the City had a green tint, and the rays of the sun were green.
...
const chapter_12_name = 'Chapter XII'
const chapter_12_header = 'The Search for the Wicked Witch'
const chapter_12_text = `The soldier with the green whiskers led them through the streets of the Emerald City until they reached the room where the Guardian of the Gates lived. This officer unlocked their spectacles to put them back in his great box, and then he politely opened the gate for our friends.
...
const chapter_13_name = 'Chapter XIII'
const chapter_13_header = 'The Rescue'
const chapter_13_text = `The Cowardly Lion was much pleased to hear that the Wicked Witch had been melted by a bucket of water, and Dorothy at once unlocked the gate of his prison and set him free. They went in together to the castle, where Dorothy’s first act was to call all the Winkies together and tell them that they were no longer slaves.
...
const chapter_15_name = 'Chapter XV'
const chapter_15_header = 'The Discovery of Oz, the Terrible'
const chapter_15_text = `The four travelers walked up to the great gate of Emerald City and rang the bell. After ringing several times, it was opened by the same Guardian of the Gates they had met before.
...
const chapter_16_name = 'Chapter XVI'
const chapter_16_header = 'The Magic Art of the Great Humbug'
const chapter_16_text = `Next morning the Scarecrow said to his friends:
...
const chapter_18_name = 'Chapter XVIII'
const chapter_18_header = 'Away to the South'
const chapter_18_text = `Dorothy wept bitterly at the passing of her hope to get home to Kansas again; but when she thought it all over she was glad she had not gone up in a balloon. And she also felt sorry at losing Oz, and so did her companions.
...
const chapter_20_name = 'Chapter XX'
const chapter_20_header = 'The Dainty China Country'
const chapter_20_text = `While the Woodman was making a ladder from wood which he found in the forest Dorothy lay down and slept, for she was tired by the long walk. The Lion also curled himself up to sleep and Toto lay beside him.
...
const chapter_22_name = 'Chapter XXII'
const chapter_22_header = 'The Country of the Quadlings'
const chapter_22_text = `The four travelers passed through the rest of the forest in safety, and when they came out from its gloom saw before them a steep hill, covered from top to bottom with great pieces of rock.
...
const chapter_23_name = 'Chapter XXIII'
const chapter_23_header = 'Glinda The Good Witch Grants Dorothy’s Wish'
const chapter_23_text = `Before they went to see Glinda, however, they were taken to a room of the Castle, where Dorothy washed her face and combed her hair, and the Lion shook the dust out of his mane, and the Scarecrow patted himself into his best shape, and the Woodman polished his tin and oiled his joints.
...
const chapter_24_name = 'Chapter XXIV'
const chapter_24_header = 'Home Again'
const chapter_24_text = `Aunt Em had just come out of the house to water the cabbages when she looked up and saw Dorothy running toward her.
