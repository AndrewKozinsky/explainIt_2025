export const chapter_36 = {
	name: 'XXXVI',
	header: 'Finalmente Pinocchio cessa d\'essere un burattino e diventa un ragazzo.',
	text: `Mentre Pinocchio nuotava alla svelta per raggiungere la spiaggia, si accòrse che il suo babbo, il quale gli stava a cavalluccio sulle spalle e aveva le gambe mezze nell'acqua, tremava fitto fitto, come se al pover'uomo gli battesse la febbre terzana.
...
— Pesi? Neanche per ombra: mi par di aver addosso due gusci di conchiglia — rispose il Tonno, il quale era di una corporatura così grossa e robusta, da parere un vitello di due anni.
...
Non avevano ancora fatti cento passi, che videro seduti sul ciglione della strada due brutti ceffi, i quali stavano lì in atto di chieder l'elemosina.
...
— Non ti ricordi di quella Lumaca, che stava per cameriera con la Fata dai capelli turchini? non ti rammenti di quella volta quando scesi a farti lume, e tu rimanesti con un piede confitto nell'uscio di casa?
...
— Non mi è stato possibile di trovarne uno che mi tornasse bene. Pazienza!... Lo comprerò un'altra volta. —
...
Appena si fu vestito, gli venne fatto, naturalmente di mettere le mani nelle tasche e tirò fuori un piccolo portamonete d'avorio, sul quale erano scritte queste parole: «La Fata dai capelli turchini restituisce al suo caro Pinocchio i quaranta soldi, e lo ringrazia tanto del suo buon cuore.» Aperto il portafoglio, invece di quaranta soldi di rame, vi luccicavano quaranta zecchini d'oro tutti nuovi di zecca.
