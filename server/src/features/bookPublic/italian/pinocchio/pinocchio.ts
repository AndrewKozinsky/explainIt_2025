...
export function pinocchioBookData(s3FolderName: string) {
	...
	return {
		...
		about: `Сказка рассказывает о деревянной кукле Пиноккио, которую мастер Джеппетто вырезает из полена. Пиноккио оживает, но ведёт себя как непослушный и очень любопытный ребёнок: он убегает из дома, не хочет ходить в школу, легко верит обманщикам и постоянно попадает в опасные ситуации.
