...
export function heartBookData(s3FolderName: string) {
	...
	return {
		...
		name: 'Cuore',
		about: `Книга рассказывает о жизни итальянских детей, семье, школе, дружбе, долге и воспитании характера. В центре повествования — мир ученика, который наблюдает за одноклассниками, учителями и родителями, учится понимать других людей и постепенно взрослеет. Большое внимание уделяется обычным школьным ситуациям: урокам, отношениям между детьми, успехам и неудачам, помощи слабым, уважению к старшим.
