...
export function donQuixoteBookData(s3FolderName: string) {
	...
	return {
		...
		about: `Роман рассказывает о пожилом идальго Алонсо Кихано, который слишком много читает рыцарских романов и однажды решает сам стать странствующим рыцарем. Он берёт себе имя Дон Кихот Ламанчский, надевает старые доспехи, выбирает коня Росинанта и отправляется в путь, чтобы защищать слабых, совершать подвиги и прославить свою воображаемую даму сердца — Дульсинею Тобосскую.
