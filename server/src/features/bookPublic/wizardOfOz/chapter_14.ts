	...
	data: [
		{
			...
			translate:
				'Вы помните, что между замком Злой Ведьмы и Изумрудным городом не было ни дороги, ни даже тропинки.',
		},
		{
			sentence:
			...
			translate:
				'Когда четверо путешественников отправились на поиски Ведьмы, она увидела их приближение и послала Крылатых Обезьян привести их к себе.',
		},
		{
			sentence:
			...
			translate:
				'Гораздо труднее было найти дорогу обратно через большие поля лютиков и жёлтых маргариток, чем когда их несли.',
		},
		{
			sentence:
				'They knew, of course, they must go straight east, toward the rising sun; and they started off in the right way.',
			translate:
				'Они, конечно, знали, что нужно идти прямо на восток, к восходящему солнцу; и двинулись в верном направлении.',
		},
		{
			sentence:
			...
			translate:
				'Но в полдень, когда солнце было над головой, они уже не понимали, где восток, а где запад, и поэтому заблудились в бескрайних полях.',
		},
		{
			sentence: 'They kept on walking, however, and at night the moon came out and shone brightly.',
			translate: 'Однако они продолжали идти, и ночью вышла луна и ярко засветила.',
		},
		{
			sentence:
			...
			translate:
				'Поэтому они легли среди благоухающих жёлтых цветов и крепко спали до утра — все, кроме Пугала и Железного Дровосека.',
		},
		{
			sentence:
				'The next morning the sun was behind a cloud, but they started on, as if they were quite sure which way they were going.',
			translate:
				'На следующее утро солнце скрывалось за тучей, но они всё же тронулись в путь, словно точно знали, куда идут.',
		},
		{
		...
		},
		{
			...
			translate:
				'«Мне кажется, я едва могу дождаться, когда доберусь до Оза, и ты должен признать, что это очень долгий путь».',
		},
		{
			sentence:
			...
			translate:
				'«Понимаешь, — всхлипнул Трусливый Лев, — у меня не хватает мужества брести вечно, никуда не приходя».',
		},
		{ sentence: 'Then Dorothy lost heart.', translate: 'Тут Дороти упала духом.' },
		{
			sentence:
			...
			translate:
				'Она села на траву и посмотрела на своих товарищей, а они сели и посмотрели на неё, и Тото понял, что впервые в жизни слишком устал, чтобы погнаться за бабочкой, пролетевшей у него над головой.',
		},
		{
			sentence:
		...
		{ sentence: '“Why didn’t we think of that before?”', translate: '«Почему мы не додумались до этого раньше?»' },
		{
			...
			translate:
				'Дороти свистнула в маленький свисток, который всегда носила на шее с тех пор, как Королева Мышей подарила его ей.',
		},
		{
			sentence:
				'In a few minutes they heard the pattering of tiny feet, and many of the small gray mice came running up to her.',
			translate:
				'Через несколько минут они услышали топот крошечных лапок, и к ней подбежало множество маленьких серых мышек.',
		},
		{
			sentence: 'Among them was the Queen herself, who asked, in her squeaky little voice:',
			translate: 'Среди них была и сама Королева, которая пронзительным тонким голоском спросила:',
		},
		{ sentence: '“What can I do for my friends?”', translate: '«Что я могу сделать для своих друзей?»' },
		{
			sentence: '“We have lost our way,” said Dorothy.',
			translate: '«Мы заблудились», — сказала Дороти.',
		},
		{
			sentence: '“Can you tell us where the Emerald City is?”',
			translate: '«Не подскажете, где Изумрудный город?»',
		},
		{
			sentence:
				'“Certainly,” answered the Queen; “but it is a great way off, for you have had it at your backs all this time.”',
			translate:
				'«Разумеется, — ответила Королева. — Но он очень далеко, ведь всё это время он находился у вас за спиной».',
		},
		{
			sentence:
		...
		{ sentence: '“What is it?”', translate: '«Что это за чары?»' },
		{
			sentence: '“It is written inside the Golden Cap,” replied the Queen of the Mice.',
			translate: '«Они написаны внутри Золотой Шапки», — ответила Королева Мышей.',
		},
		{
			sentence:
		...
		},
		{
			...
			translate:
				'На этом произнесение заклинания закончилось, и они услышали громкое щебетание и хлопанье крыльев — к ним подлетел отряд Крылатых Обезьян.',
		},
		{
			sentence: 'The King bowed low before Dorothy, and asked, “What is your command?”',
		...
		},
		{
			...
			translate:
				'«Мы понесём вас», — ответил Король, и не успел он это сказать, как две Обезьяны подхватили Дороти на руки и улетели с ней.',
		},
		{
			sentence:
			...
			translate:
				'Другие взяли Пугало, Дровосека и Льва, а одна маленькая Обезьянка схватила Тото и полетела следом, хотя пёс изо всех сил пытался её укусить.',
		},
		{
			sentence:
			...
			translate:
				'Пугало и Железный Дровосек сперва немного испугались, ведь помнили, как плохо с ними обращались Крылатые Обезьяны раньше;',
		},
		{
			sentence:
			...
			translate:
				'но они поняли, что зла не замышляется, и летели по воздуху довольно весело, любуясь красивыми садами и лесами далеко внизу.',
		},
		{
			sentence:
		...
		},
		{
			...
			translate:
				'«Когда‑то, — начал вождь, — мы были свободным народом, счастливо жили в большом лесу, перелетая с дерева на дерево, поедая орехи и плоды и делая всё, что хотели, не называя никого господином.',
		},
		{
			sentence:
			...
			translate:
				'Пожалуй, иной раз в нас было слишком много озорства: мы слетали вниз, дёргали за хвосты животных без крыльев, гонялись за птицами и бросали орехи в людей, гулявших по лесу.',
		},
		{
		...
		},
		{
			...
			translate:
				'Гайелетт решила, что когда он станет мужчиной, сделает его своим мужем, и отвела его в свой рубиновый дворец, где употребила всю свою магию, чтобы сделать его столь сильным, добрым и прекрасным, насколько только может желать женщина.',
		},
		{
			sentence:
			...
			translate:
				'Когда он возмужал, Куелала, как его звали, слыл лучшим и мудрейшим человеком во всей стране, а мужественная красота его была столь велика, что Гайелетт горячо его полюбила и поспешила приготовить всё к свадьбе.',
		},
		{
			sentence:
		...
		},
		{
			...
			translate:
				'На нём был богатый наряд из розового шёлка и пурпурного бархата, и мой дед решил посмотреть, что можно устроить.',
		},
		{
			sentence:
		...
		},
		{
			...
			translate:
				'Она велела привести к ней всех Крылатых Обезьян и сперва сказала, что им следует связать крылья и поступить с ними так, как они поступили с Куелалой, — бросить в реку.',
		},
		{
			sentence:
		...
		},
		{
			...
			translate:
				'«Куелала, будучи первым владельцем Золотой Шапки, — ответила Обезьяна, — первым возложил на нас свои пожелания.',
		},
		{
			sentence:
			...
			translate:
				'Поскольку его невеста не могла нас видеть, он собрал нас у себя в лесу после свадьбы и велел держаться там, где она больше никогда не увидит Крылатых Обезьян, чему мы были только рады, ведь все её боялись.',
		},
		{
			sentence:
