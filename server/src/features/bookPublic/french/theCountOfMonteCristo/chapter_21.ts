export const chapter_21 = {
	...
	text: `Dantès étourdi, presque suffoqué, eut cependant la présence d’esprit de retenir son haleine, et, comme sa main droite, ainsi que nous l’avons dit, préparé qu’il était à toutes les chances, tenait son couteau tout ouvert, il éventra rapidement le sac, sortit le bras, puis la tête ; mais alors, malgré ses mouvements pour soulever le boulet, il continua de se sentir entraîné ; alors il se cambra, cherchant la corde qui liait ses jambes, et, par un effort suprême, il la trancha précisément au moment où il suffoquait ; alors, donnant un vigoureux coup de pied, il remonta libre à la surface de la mer, tandis que le boulet entraînait dans ses profondeurs inconnues le tissu grossier qui avait failli devenir son linceul.
...
C’est alors qu’il se félicita de cette précaution qu’il avait prise de s’étendre sur une solive.
Affaibli comme il était, peut-être n’eût-il pas pu se soutenir sur la mer jusqu’à ce qu’il eût rejoint la tartane ; et, à coup sûr, si la tartane, ce qui était possible, passait sans le voir, il n’eût pas pu regagner la côte.
...
Il poussa un grand cri, les deux rameurs redoublèrent d’énergie, et l’un d’eux lui cria en italien :
« Courage ! »
...
– D’où venez-vous ?
– De ces rochers où j’avais eu le bonheur de me cramponner, tandis que notre pauvre capitaine s’y brisait la tête. Nos trois autres compagnons se sont noyés. Je crois que je suis le seul qui reste vivant ; j’ai aperçu votre navire, et, craignant d’avoir longtemps à attendre sur cette île isolée et déserte, je me suis hasardé sur un débris de notre bâtiment pour essayer de venir jusqu’à vous.
Merci, continua Dantès, vous m’avez sauvé la vie ; j’étais perdu quand l’un de vos matelots m’a saisi par les cheveux.
...
– De quoi diable te mêles-tu ? Cela te regardet-il, Jacopo ? dit le patron ; chacun est libre de s’engager pour la somme qui lui convient.
