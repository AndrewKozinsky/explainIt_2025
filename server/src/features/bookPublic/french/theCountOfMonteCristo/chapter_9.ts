export const chapter_9 = {
	...
	text: `Villefort, comme nous l’avons dit, avait repris le chemin de la place du Grand-Cours, et en rentrant dans la maison de Mme de Saint-Méran, il trouva les convives qu’il avait laissés à table passés au salon en prenant le café..
...
Villefort se leva, ou plutôt bondit, comme un homme qui triomphe d’une lutte intérieure, courut à son secrétaire, versa dans ses poches tout l’or qui se trouvait dans un des tiroirs, tourna un instant effaré dans la chambre, la main sur son front, et articulant des paroles sans suite ; puis enfin, sentant que son valet de chambre venait de lui poser son manteau sur les épaules, il sortit, s’élança en voiture, et ordonna d’une voix brève de toucher rue du Grand-Cours, chez M. de SaintMéran.
