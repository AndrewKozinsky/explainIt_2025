export const chapter_11 = {
	...
	text: `Louis XVIII, à l’aspect de ce visage bouleversé, repoussa violemment la table devant laquelle il se trouvait.
...
– Parlez, monsieur, parlez hardiment, dit le roi ; vous seul nous avez prévenu du mal, aidez230 nous à y chercher le remède.
...
Le ministre de la Police remercia le jeune homme par un regard éloquent, et Villefort comprit qu’il avait réussi dans son projet, c’est-àdire que, sans rien perdre de la reconnaissance du roi, il venait de se faire un ami sur lequel, le cas échéant, il pouvait compter.
