...
export function aStudyInScarletPartTwoBookData(s3FolderName: string) {
	const coverFileName = 'a_study_in_scarlet_part_two.jpg'

	return {
		author: 'Arthur Conan Doyle',
		name: 'A study in scarlet (part 2)',
		about: `Рассказ резко меняет направление и переносит читателя в Америку. История уже не ведётся от лица Ватсона и почти не связана с Холмсом напрямую. Здесь показаны события прошлого, которые объясняют причины преступления.
