...
export function oliverTwistBookData(s3FolderName: string) {
	...
	return {
		...
		name: 'Oliver Twist',
		about: `Роман рассказывает о судьбе Оливера Твиста — мальчика-сироты, который рождается в работном доме и с первых дней жизни сталкивается с бедностью, холодностью и жестокостью. Он растёт среди людей, для которых бедный ребёнок — скорее обуза, чем человек, нуждающийся в заботе. После унижений и тяжёлых условий Оливер решается бежать в Лондон.
