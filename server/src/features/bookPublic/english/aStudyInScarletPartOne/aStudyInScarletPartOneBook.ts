...
export function aStudyInScarletPartOneBookData(s3FolderName: string) {
	...
	return {
		...
		name: 'A study in scarlet (part 1)',
		about: `Рассказ ведётся от лица доктора Ватсона — военного врача, который возвращается в Лондон после войны. Он знакомится с Шерлоком Холмсом и вместе с ним снимает квартиру на Бейкер-стрит. Вскоре Ватсон понимает, что Холмс — необычный человек с выдающимися способностями к логике и наблюдению.
