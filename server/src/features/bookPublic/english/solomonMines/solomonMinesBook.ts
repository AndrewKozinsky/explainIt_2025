...
export function solomonMinesBookData(s3FolderName: string) {
	...
	return {
		...
		about: `Роман рассказывает о путешествии охотника и проводника Аллана Квотермейна, который соглашается помочь двум английским джентльменам найти пропавшего брата одного из них. Поиски ведут героев вглубь Африки, к легендарным копям царя Соломона, где, по слухам, скрыты огромные сокровища.
