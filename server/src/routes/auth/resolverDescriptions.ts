...
export const authResolversDesc: Record<keyof typeof AuthResolver.prototype, string> = {
	...
	Possible errors:
	**${errorMessage.email.emailIsNotConfirmed}** — the user is already registered, but doesn't confirm his email.
	**${errorMessage.email.emailIsAlreadyRegistered}** — the user is already registered and confirmed his email.`,
	login: 'User login',
