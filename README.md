...
#### Сохранение видео в Premier Pro
Для сохранения видео в минимальном размере и максимальном качестве в Premier Pro нужно зайти на вкладку Export.
В Location установить путь сохранения файла.
В Format поставить QuickTime.
В Video Codec поставить Apple ProRes 422 HQ.
Выключить аудио при необходимости.

Затем к файлу применить следующую команду для уменьшения размера:
