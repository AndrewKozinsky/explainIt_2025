...
import Sentences from '@/entites/sentencesAndSubtitles/Sentences/Sentences'
import { VideoContentType, VideoSubtitlesModel } from '@/entites/videos/repository/VideosRepository'
