...
export const serverErrorMessagesByCode: Record<string, ServerErrorMessageResolver> = {
	...
	MUST_BE_BOOLEAN: (errorMessage) => errorMessage.fieldName + ' должен быть boolean.',
	...
	MUST_BE_ENUM_VALUE: (errorMessage) => errorMessage.fieldName + ' должен быть валидным значением.',
	STRING_DOES_NOT_MATCH: (errorMessage) => errorMessage.fieldName + ' не соответствует формату.',
	...
	UNIVERSAL_PHRASE_TRANSLATION_CANNOT_PARSE_LLM_RESPONSE: 'Не удалось разобрать ответ ИИ.',
	UNIVERSAL_PHRASE_TRANSLATION_CANNOT_GET_TRANSLATION_FROM_LLM: 'Не удалось получить перевод от ИИ.',
