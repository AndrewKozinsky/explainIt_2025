	...
	content: [
		...
		{ type: 'header', tag: 'h2', style: 'h2', text: 'Have в значении владения' },
		{
			...
			children: [
				{
					type: 'text',
					text: 'В русском языке владение выражается через личное местоимения в родительском падеже. А в английском для этого используется глагол ',
				},
				{
					type: 'text',
					text: 'have',
