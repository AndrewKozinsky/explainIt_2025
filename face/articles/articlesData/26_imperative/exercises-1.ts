...
const exercises_1: ExercisesType.ExercisesObj = {
	...
	exercises: [
		...
		},
		{
			...
			engSentences: [
				{
					engSentences: ['More energy, please!'],
					isCorrect: true,
				},
			],
			words: [
		...
		},
		{
			...
			engSentences: [
				{
					engSentences: ['Separate the yolk from the white.'],
					isCorrect: true,
				},
			],
			words: [
		...
		},
		{
			...
			engSentences: [
				{
					engSentences: ['Quick! Change channels!'],
					isCorrect: true,
				},
			],
			words: [
		...
		},
		{
			...
			engSentences: [
				{
					engSentences: ['Measure the distance between the shelves.'],
					isCorrect: true,
				},
			],
			words: [
		...
		},
		{
			...
			engSentences: [
				{
					engSentences: ['Close your eyes and relax.'],
					isCorrect: true,
				},
			],
			words: [
		...
		},
		{
			...
			engSentences: [
				{
					engSentences: ['Come here, give me your hand.'],
					isCorrect: true,
				},
			],
			words: [
		...
		},
		{
			...
			engSentences: [
				{
					engSentences: ['Go to Migros and buy some kitten food.'],
					isCorrect: true,
				},
			],
			words: [
		...
		},
		{
			...
			engSentences: [
				{
					engSentences: ['Leave it to me, my friend, I have a plan!'],
					isCorrect: true,
				},
			],
			words: [
		...
		},
		{
			...
			engSentences: [
				{
					engSentences: ['Turn to the right at the crossroads.'],
					isCorrect: true,
				},
			],
			words: [
