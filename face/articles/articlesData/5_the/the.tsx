	...
	content: [
			...
			children: [
				{
					...
					children: [
						{
							type: 'text',
							text: 'С точки зрения русского языка такое уточнение избыточно. Но англоговорящие мыслят другими категориями и приходится перестраивать своё мышление чтобы говорить грамотно.',
						},
					],
				},
			],
		...
		},
		{
			...
			children: [
				{
					type: 'text',
					text: 'Например Соединённое Королевство пишется с the потому что это конкретная и единственная страна. Другой нет.',
				},
			],
		},
		{
		...
		},
		{
			...
			children: [
				{
					type: 'text',
					text: 'Но в отношении Франции, России the не ставится, хотя это тоже страны.',
				},
			],
		},
		{
		...
		},
		{
			...
			children: [
				{
					type: 'text',
					text: 'Но перед названием музыкальных всегда ставят the хотя всегда имеют в виду любой музыкальный инструмент.',
				},
			],
		},
		{
		...
		},
		{
			...
			children: [
				{
					type: 'text',
					text: 'С некоторыми существительным: «озеро», «река», «парк», «лес», «кинотеатр», «телефон» всегда используют с the даже если не подразумевают конкретное место или вещь.',
				},
			],
		},
		{
		...
		},
		{
			...
			children: [
				{
					type: 'text',
					text: 'Такие исключения будут последовательно разбираться в последующих статьях.',
				},
			],
		},
	],
