	...
	content: [
		{
			...
			children: [
				{
					type: 'text',
					text: 'В предыдущих главах уже встречались существительные во множественном числе и вы могли заметить, что они образовываются из единственного числа добавлением окончания -s. Это самый распространённый, но не универсальный способ. Давайте рассмотрим все.',
				},
			],
		},
