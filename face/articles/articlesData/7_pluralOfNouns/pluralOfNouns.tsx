...
const pluralOfNouns: ArticleType.Art = {
	meta: {
		...
		description: 'Разберём способы образования множественного числа существительных от основных до исключений.',
		keywords: 'множественное число существительных, презент симпл, present simple',
	},
	content: [
		{
			type: 'paragraph',
