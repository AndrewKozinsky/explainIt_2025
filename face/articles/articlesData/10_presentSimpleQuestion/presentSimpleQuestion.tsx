			...
			children: [
				{
					...
					children: [
						{
							type: 'text',
							text: 'Приводя выше такое большое описание образования вопроса я ставил целью чтобы вы понимали почему вообще слово likes превращается в like, а do в does, а не только механически подставляли слова. Даже если забудите схему, то понимая логику образования вопросительного предложения сможете самостоятельно её вычислить.',
						},
					],
				},
			],
