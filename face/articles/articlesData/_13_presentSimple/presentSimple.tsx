	...
	content: [
		{
			...
			children: [
				...
				{ type: 'text',  weight: 'bold', text: 'подлежащее + глагол' },
				{
					type: 'text',
				...
				{ type: 'text',  text: ' (Present Simple) и ' },
				{ type: 'text',  weight: 'bold', text: 'будущего' },
				{ type: 'text',  text: ' (Future Simple).' },
			],
		},
		{
			type: 'paragraph',
		...
		},
		{
			...
			textSize: 'giant',
			children: [
				{ type: 'text',  text: 'Она уборщица' },

				{ type: 'text',  text: 'She is a janitor' },
			],
		},
		{
			type: 'paragraph',
		...
		},
		{
			...
			textSize: 'giant',
			children: [
				{ type: 'text',  text: 'Ваня спит после обеда.' },

				{ type: 'text',  text: 'Vanya sleep' },
				{ type: 'text', color: 'blue', text: 's' },
		...
		},
		{
			...
			children: [
				...
				{ type: 'text',  text: 'She ki' },
				{ type: 'text', color: 'gold', text: 'ss' },
				{ type: 'text', color: 'blue', text: 'es' },
				{ type: 'text',  text: ' me every day.' },
			],
		},
		{
			type: 'note',
