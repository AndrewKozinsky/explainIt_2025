		...
		<MainPageBlockWrapper header='Что по стоимости'>
			<div className='what-about-cost-texts'>
				<Paragraph fontSize={20}>
					Каждое обращение к ИИ расходует баланс — в среднем 5–15 копеек. Стоимость зависит от сложности
					перевода.
				</Paragraph>
				<Paragraph fontSize={20}>
					Минимальное пополнение — 10 рублей. Никаких подписок и скрытых платежей — вы платите только за то,
					что используете.
				</Paragraph>
				<Paragraph fontSize={20}>
