		...
		<MainPageBlockWrapper header='Что по стоимости'>
			<div className='what-about-cost-texts'>
				<Paragraph fontSize={20}>
					Каждое обращение к ИИ расходует баланс — в среднем 10–20 копеек. Минимальное пополнение — 10 рублей.
					Никаких подписок, никаких скрытых платежей — вы платите только за то, что используете.
				</Paragraph>
				<Paragraph fontSize={20}>
