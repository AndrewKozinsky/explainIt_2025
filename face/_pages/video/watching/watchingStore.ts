...
export const watchingStoreValues: WatchingStoreValues = {
	...
	// chapter: null as any as WatchingStore.ChapterData,
...
export const useWatchingStore = create<WatchingStoreNext>()((set, get) => {
	return {
		...
		/*updateChapter: (chapter: WatchingStore.ChapterData) => {
			set((state) => {
				return {
					chapter,
				}
...
export type WatchingStoreValues = {
	...
	// chapter: WatchingStore.ChapterData
...
export type WatchingStoreMethods = {
	...
	// updateChapter: (chapter: WatchingStore.ChapterData) => void
