	...
	content: [
		{
			...
			children: [
				{
					type: 'text',
					text: 'В русском языке вопросительное предложение можно сделать просто поставив знак вопроса на письме, а в разговоре сказав с вопросительной интонацией. Но в английском другой механизм. Нужно один раз понять как это работает потому что вопросительные предложения в остальных временах будут строиться похожим образом.',
				},
			],
		},
		{
			...
			children: [
				{
					...
					children: [
						...
						{
							type: 'text',
							text: '. Смысловой несёт смысл (красить, читать). Вспомогательные не несут смысла и никак не переводятся, но участвуют в формировании вопроса и отрицания.',
						},
					],
				},
				{
		...
		},
		{
			...
			textSize: 'giant',
			parts: [
				{ rus: [{ type: 'text', text: 'Они покупают это онлайн?' }] },
				{ eng: [{ type: 'text', text: 'Do they buy it online?' }] },
			],
		},
		exercises_1,
	],
